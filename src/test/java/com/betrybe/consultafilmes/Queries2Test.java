...
public class Queries2Test {
  ...
  @Test
  @DisplayName(
      "Consulta 2 - consulta deve retornar uma lista vazia quando nenhum artista atende ao requisito"
  )
  ...
  @Test
  @DisplayName("Consulta 2 - nenhum artista deve aparecer mais de uma vez na lista de resultados")
